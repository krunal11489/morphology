...
function CheckPrms(block)
  ...
  a1 = block.DialogPrm(2).Data;
  if ~strcmp(class(a1), 'double')
    me = MSLException(block.BlockHandle, message('Simulink:blocks:invalidParameter'));
    throw(me);
  end
...
block.OutputPort(1).Data = imregister(block.InputPort(1).Data,block.InputPort(2).Data,'affine',optimizer,metric);
%  endfunction
