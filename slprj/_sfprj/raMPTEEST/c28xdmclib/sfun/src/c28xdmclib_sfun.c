  ...
  int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==2) {
    c2_c28xdmclib_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"c28xdmclib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1925693175U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1773535575U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2147374916U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1600503410U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 2:
            {
              extern void sf_c2_c28xdmclib_get_check_sum(mxArray *plhs[]);
              sf_c2_c28xdmclib_get_check_sum(plhs);
              break;
            }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        if (strcmp(aiChksum, "LwZ5Y8NgDbThYVPSlo2mUD") == 0) {
          extern mxArray *sf_c2_c28xdmclib_get_autoinheritance_info(void);
          plhs[0] = sf_c2_c28xdmclib_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 2:
      {
        extern const mxArray *sf_c2_c28xdmclib_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c2_c28xdmclib_get_eml_resolved_functions_info();
