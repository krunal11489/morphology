...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_motor28335_2_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_c28xdmclib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_motor28335_2_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_c28xdmclib_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_motor28335_2_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_c28xdmclib_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "motor28335_2") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_motor28335_2_autoinheritance_info(nlhs,plhs,3,newRhs);
  }

  if (strcmp(machineName, "c28xdmclib") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_c28xdmclib_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_motor28335_2_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_c28xdmclib_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "motor28335_2") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_motor28335_2_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "c28xdmclib") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_c28xdmclib_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_motor28335_2_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_c28xdmclib_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"motor28335_2")) {
    return(sf_motor28335_2_method_dispatcher(simstructPtr,chartFileNumber,
            specsCksum,method,data));
  }

  if (!strcmp(machineName,"c28xdmclib")) {
    return(sf_c28xdmclib_method_dispatcher(simstructPtr,chartFileNumber,
            specsCksum,method,data));
  }
...
extern void motor28335_2_terminator(void);
extern void c28xdmclib_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    motor28335_2_terminator();
    c28xdmclib_terminator();
    sf_debug_terminate();
  }
...
extern void motor28335_2_initializer(void);
extern void c28xdmclib_initializer(void);
extern void motor28335_2_register_exported_symbols(SimStruct* S);
extern void c28xdmclib_register_exported_symbols(SimStruct* S);
extern void motor28335_2_debug_initialize(void);
extern void c28xdmclib_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  motor28335_2_register_exported_symbols(S);
  c28xdmclib_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      motor28335_2_debug_initialize();
    }

    motor28335_2_initializer();
    if (!simModeIsRTWGen) {
      c28xdmclib_debug_initialize();
    }

    c28xdmclib_initializer();
  }
